...
@class XiMaLaYaAlbumModel,XiMaLaYaTracksModel,XiMaLaYaTracksListModel;
@interface XiMaLaYaBaseModel : BaseModel

@property (nonatomic, strong) XiMaLaYaTracksModel *tracks;

@property (nonatomic, strong) XiMaLaYaAlbumModel *album;
...
@interface XiMaLaYaTracksModel : BaseModel

@property (nonatomic, assign) NSInteger maxPageId;

@property (nonatomic, strong) XiMaLaYaTracksListModel *list;
...
@interface XiMaLaYaTracksListModel : BaseModel
